	...
	var password=document.getElementById("pwdNewPassword").value;
        ...
        <form method="post" action="changepassword.php" onSubmit="return validate()">
            <table border="5">
                <tr>
                    <th>Old Password</th>
                    <th><input type="password" name="pwdOldPassword" placeholder="Enter the Old Password" id="pwdOldPassword" /></th>
                </tr>
                
                 <tr>
                    <th>New Password</th>
                    <th><input type="password" name="pwdNewPassword" placeholder="Enter the New Password" id="pwdNewPassword" /></th>
                </tr>
                
                 <tr>
                    <th>Reenter New Password</th>
                    <th><input type="password" name="pwdReenterNewPassword" placeholder="Reenter New Password" id="pwdReenterNewPassword"/></th>
                </tr>
