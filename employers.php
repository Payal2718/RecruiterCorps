...
<tr>
	...
	echo "<table width=600 align=center border=1 bgcolor=#3399FF><tr>";
	echo "<th>Company Logo</th>";
	echo "<th>Company Name</th>";
	echo "<th>Company profile</th>";
	echo "<th>Company phone No.</th>";
	while($r=mysql_fetch_row($query))
	{
		...
		echo "<td align='center'><img src=companyimages/$imgres width=100px height=100px></td>";
		echo "<td align=center>$r[1]</td>";
		echo "<td align=center><a href='$r[9]'>$r[9]</a></td>";
